    ...
    <div class="overflow-x-auto">
        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
            ...
            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                ...
                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                    <td class="px-4 sm:px-6 py-4 whitespace-nowrap">
                        <div class="flex items-center">
                            <div class="flex-shrink-0 h-8 w-8 sm:h-10 sm:w-10 rounded-md bg-blue-100 dark:bg-blue-900 flex items-center justify-center">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 sm:h-5 sm:w-5 text-blue-600 dark:text-blue-300" viewBox="0 0 20 20" fill="currentColor">
                            ...
                            <div class="ml-3 sm:ml-4">
                                ...
                                <div class="text-xs sm:text-sm text-gray-500 dark:text-gray-400">{{ $category->items->count() ?? 0 }} items</div> 
                            </div>
                        </div>
                    </td>
                ...
                @empty
                <tr>
                    <td colspan="3" class="px-4 sm:px-6 py-4 text-center text-sm text-gray-500 dark:text-gray-400">
                        <div class="flex flex-col items-center justify-center py-6 sm:py-8">
                            ...
                            <p class="mt-1 text-xs sm:text-sm text-gray-500 dark:text-gray-400">Get started by creating a new category.</p>
                        </div>
                    </td>
                </tr>
                @endforelse
