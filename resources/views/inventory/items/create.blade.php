                ...
                <div class="px-4 py-5 sm:px-6">
                    ...
                    <div class="mt-1">
                        <textarea id="description" name="description" rows="4"
                                  class="block w-full border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 @error('description') border-red-500 @enderror"
                                  placeholder="Provide detailed information about this product...">{{ old('description') }}</textarea>
                    </div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (!barcodeInput.value) {
            barcodeInput.placeholder = 'BAR' + Math.floor(1000 + Math.random() * 9000);
        }
    });
</script>
@endpush