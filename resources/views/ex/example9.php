...
<body class="min-h-screen bg-gray-50 flex items-center justify-center bg-[url('https://images.unsplash.com/photo-1556740738-b6a63e27c4df?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80')] bg-cover bg-center bg-blend-overlay bg-primary-100">
    <div class="w-full max-w-md px-6 py-12">
        <div class="bg-white rounded-xl shadow-xl overflow-hidden">
            <!-- Header -->
            <div class="bg-primary-700 py-6 px-8 text-center">
                <div class="flex justify-center mb-4">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-12 w-12 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 14v3m4-3v3m4-3v3M3 21h18M3 10h18M3 7l9-4 9 4M4 10h16v11H4V10z" />
                    </svg>
                </div>
                <h1 class="text-2xl font-bold text-white">Warehouse Management</h1>
                <p class="text-primary-100 mt-1">Inventory Control System</p>
            </div>
            ...
            <div class="px-8 py-8">
                <form class="space-y-6">
                    <div>
                        <label for="username" class="block text-sm font-medium text-secondary-600 mb-1">Username</label>
                        <div class="relative">
                    ...
                    <div>
                        <label for="warehouse" class="block text-sm font-medium text-secondary-600 mb-1">Warehouse</label>
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                            ...
                            <select id="warehouse" name="warehouse" required
                                    class="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-primary-500 focus:border-primary-500 sm:text-sm appearance-none bg-white">
                                <option value="" disabled selected>Select warehouse</option>
                                <option value="main">Main Warehouse</option>
                                <option value="north">North Distribution Center</option>
                                <option value="south">South Storage Facility</option>
                                <option value="east">East Regional Hub</option>
                                <option value="west">West Logistics Center</option>
                            </select>
                    ...
                    <div>
                        <label for="password" class="block text-sm font-medium text-secondary-600 mb-1">Password</label>
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-secondary-400" viewBox="0 0 20 20" fill="currentColor">
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            ...
                            <label for="remember-me" class="ml-2 block text-sm text-secondary-600">Remember me</label>
                        </div>
            ...
            <div class="bg-gray-50 px-8 py-4 text-center">
                <p class="text-xs text-secondary-500">
                    &copy; 2023 Warehouse Management System. All rights reserved.
                </p>
            </div>
        </div>
    </div>
