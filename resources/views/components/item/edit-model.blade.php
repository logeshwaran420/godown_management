  <div id="modalOverlay" class="fixed inset-0 z-50 overflow-y-auto" style="display:none;">
        <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div id="modalContent"
                ...
                <!-- Form Content -->
                <div class="bg-white">
                    <form action="{{ route('inventory.items.update',$item) }}" method="POST" enctype="multipart/form-data" id="create-item-form">
                            ...
                            @enderror
                                ...
                                {{-- <div class="sm:col-span-3">
                                    ...
                                    <div class="mt-1 flex rounded-md shadow-sm">
                                        ...
                                        value="{{ old('hsn_code', $item->barcode) }}"
                        ...
                        <div class="sm:col-span-4">
                            ...
                            <div class="mt-1 flex items-center space-x-4">
                                <div class="relative group">
                                    ...
                                    @else
      <div class="h-24 w-24 rounded-lg bg-gray-50 flex items-center justify-center border border-gray-200">
