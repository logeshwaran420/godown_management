...
<div class="w-full mx-auto bg-white">
    <div class="flex justify-between items-center border-b px-6 py-4 bg-gray-50">
        <h2 class="text-xl font-semibold text-gray-800">Inwards Entry</h2>
        ...
        fetch(`/inward/${barcode}`)
            ...
            .then(item => {
                ...
                row.innerHTML = `
                    ...
                    <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-900">${item.price}</td>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        row.innerHTML = `
            ...
            <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-900">${itemCount}</td>
            <td class="px-4 py-3 whitespace-nowrap text-sm font-medium text-gray-900">${selectedItem.barcode || '-'}</td>
            <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-500">${selectedItem.category?.name || '-'}</td>
            <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-900">${selectedItem.name}</td>
            <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-500">${selectedItem.hsn_code || '-'}</td>
            <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-500">
                <input type="number" value="1" min="1" class="qtyInput w-16 border rounded-md px-2 py-1 text-center border-gray-300 focus:border-blue-500 focus:ring-blue-500">
            </td>
            <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-500">${selectedItem.unit?.name || '-'}</td>
            <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-900">${selectedItem.price || 0}</td>
            <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-900 text-right">0.00</td>
        `;
